...
ZenerithIconUrl=$(curl https://thumbnails.roblox.com/v1/places/gameicons\?placeIds\=6191725593\&size\=256x256\&format\=Png\&isCircular\=false | jq -j '.data[0].imageUrl')
